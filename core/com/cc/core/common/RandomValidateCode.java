...
public class RandomValidateCode {
    ...
    public static Log log = LogFactory.getLog(RandomValidateCode.class);
    ...
    public void getRandcode(HttpServletRequest request, HttpServletResponse response) {
        ...
        SessionUtils.removeSessionObject(request, RANDOMCODEKEY);
        SessionUtils.setSessionValue(request, RANDOMCODEKEY, randomString);
        g.dispose();
        try {
