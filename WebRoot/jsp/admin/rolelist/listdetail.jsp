	...
	<body>
		<div id="datagrid" class="mini-datagrid" style="width:98%;height:89.5%;" showPager="false">
	    	<div property="columns">
		        ...
		        <div name="uuid" field="data.uuid" width="100">岗位uuid</div>
		        <div name="name" field="data.name" width="100">岗位名称</div>
		        <div name="remark" field="data.remark" width="100">岗位备注</div>
		        <div name="lev" field="data.lev" width="200">岗位级别</div>
	    	</div>
		</div>
