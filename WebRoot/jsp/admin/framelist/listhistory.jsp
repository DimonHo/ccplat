...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		<div class="mini-splitter" style="width: 97.5%; height: 97%;">
			<div size="200" showCollapseButton="true" cls="bordernone border-right">
					<div class="mini-toolbar"
						...
						<a class="mini-button" iconCls="icon-search" onclick="getExist()"
							plain="true">启用中</a>
						<a class="mini-button" iconCls="icon-search" onclick="getDelete()"
							plain="true">已停用</a>
					</div>
					<div class="mini-fit">
					<ul id="frameTree" class="mini-tree" 
						url="ccframelist/listFrame.action" style="width: 100%;height: 100%;"
		...
		<script src="<%=basePath%>js/admin/framelist/listhistory.js" type="text/javascript"></script>
	</body>
</html>