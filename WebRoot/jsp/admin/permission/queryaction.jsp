...
<body>
    <div class="mini-fit" style="width: 100%; height: 90%;">
		...
		<div showCollapseButton="true" style="width: 100%; height: 90%;">
				 <div id="grids" class="mini-datagrid"  url="<%=basePath %>audit/getProductActSome.action" 
					...
					<div property="columns">
						...
						<div field="href" width="180" headerAlign="center" allowSort="true">
							编辑
						</div>
					</div>	
				</div>
	...
	<div class="ynnav mini-toolbar">
     ...
     <script src="<%=basePath %>js/admin/permission/queryaction.js" type="text/javascript"></script> 
</body>
</html>