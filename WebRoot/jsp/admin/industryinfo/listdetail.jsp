...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		<div id="datagrid" class="mini-datagrid" style="width:97.5%;height:90.5%;" showPager="false">
	    	<div property="columns">
		        <div name="type" field="type" width="100">类型</div>
		        <div name="uuid" field="data.uuid" width="100">行业uuid</div>
		        <div name="name" field="data.name" width="100">行业名称</div>
		        <div name="remark" field="data.remark" width="100">行业备注</div>
	    	</div>
		</div>
		<div id="detailpage" class="mini-pager" style="width:97.2%;background:#f0f3f7;border:solid 1px #ccc;" 
