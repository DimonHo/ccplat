...
<body>
	<div class="mini-splitter" style="width: 97.5%; height: 90%;">
			...
			<div showCollapseButton="true" style="width: 100%;height: 90%" cls="bordernone border-left">
				 <div class="mini-fit">
					 	<div class="mini-splitter" style="width: 100%; height: 100%;">
					 		<div size="700" showCollapseButton="true" cls="bordernone border-right">
								<div class="mini-fit">
									<div class="mini-toolbar"
										style="padding: 2px; border-top: 0; border-left: 0; border-right: 0;">
										<a>公司列表</a>
	...
	<div class="mini-toolbar" borderStyle="border-left:0;border-bottom:0;border-right:0;">
	        <a class="mini-button" style="width:60px;" onclick="openwin()">确定</a>
    ...
    <script src="<%=basePath %>js/admin/productslist/producttree.js" type="text/javascript"></script> 
</body>
</html>